...
# CORS Settings (so frontend can connect to backend)
...
# Static files (CSS, JavaScript, Images)
#Django needs to know where to find static files
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Media files (User uploaded content - like profile pictures, doubt images)
MEDIA_URL = '/media/'
